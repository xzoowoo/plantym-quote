...
export const AI_RATES: { image: AIRate; video: AIRate } = {
  ...
  video: {
    ...
    laborCost: 4701000,
    // AI 이미지 생성 항목이 별도로 있으므로, 참고이미지 생성 시도 비용(240건×130원)은 여기서 제외하고
    // 영상 생성 시도만 반영한다. (Gemini API 월간 예산 및 비용 시뮬레이터_수정 기준, 환율 1,550원/USD, 2026-07-01)
    attemptGroups: [
      { label: "영상 생성 횟수", count: 480, costPerAttempt: 2170 },
    ],
  },
};
