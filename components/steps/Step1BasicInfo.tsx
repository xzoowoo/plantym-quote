  ...
  return (
    <div className="w-full bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
      <div className="p-8 border-b border-slate-50 bg-slate-50/30">
        <h3 className="text-xl font-black text-slate-900 mb-1 tracking-tight">기본 정보</h3>
      ...
      <div className="border-t border-slate-100">
        <button
          onClick={onNext}
          disabled={!valid}
          className="w-full py-5 bg-primary text-white font-bold text-sm hover:bg-blue-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
        >
          다음 →
        </button>
      </div>
