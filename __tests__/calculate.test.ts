...
describe("calculateQuote", () => {
  ...
  test("AI 이미지 2건 → 395,009 × 2, laborCost/attemptGroups 포함", () => {
    const input: QuoteInput = {
      ...baseInput,
    ...
    expect(item!.totalCost).toBe(395009 * 2);
    expect(item!.laborCost).toBe(393709);
